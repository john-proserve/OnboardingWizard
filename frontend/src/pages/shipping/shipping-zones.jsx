...
export const ShippingZones = () => {
  useHome(false);
  return (
    <LargeCard title={title} description={description} nextPage={nextPage} step={6} optional>
      <Information>
        <p>
        ...
        <ul style={{ textAlign: 'left', width: '70%', margin: 'auto' }}>
          ...
          <li>
            All countries, same shipping options - If you want to offer the same shipping options and service levels to all countries, you can make one zone and
            include all of the countries that you want to ship to, and then enable the service levels and/or custom shipping options you want to offer for the
            zone.
          </li>
          <li>
            ...
            depending on which zone you are in. For example, you could add all EU countries to a zone called “EU” and offer live carrier rates to that zone via
            a carrier account connection, and create a second zone containing all South American countries and offer free shipping to that zone.
          </li>
          <li>
